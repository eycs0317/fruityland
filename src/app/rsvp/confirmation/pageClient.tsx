    ...
    <main role="main" className="grid justify-self-center justify-items-center w-full md:w-120 p-4">
      ...
      <div style={{ height: "auto", margin: "0 auto", maxWidth: "100%", width: "100%" }}>
            <QRCode
              ...
              // value={`${https://main.d1t1uzsb475px0.amplifyapp.com/}/verify-reservation?cc=${confirmationData?.couponCode}&uid=${confirmationData?.uid}&date=${confirmationData?.date}&time=${confirmationData?.time}`}
            />
          </div>

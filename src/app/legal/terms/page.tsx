  ...
  switch (session.lang) {
      ...
      return (
        <main role="main" className="grid justify-self-center justify-items-center w-full md:w-120 p-4">
          <section className="w-full p-8 text-center">
            <Heading level={1} content="Terms and Conditions" className="text-4xl pt-8 pb-4" />
          </section>
          <section className="w-full p-8">
            ...
            <ol className="list-decimal ml-4 text-sm">
              ...
              <li>For hygiene and safety reasons, the socks must be worn inside the Inflatable Paradise. Participants should also wear comfortable clothing. Participants can bring their non-slip socks or redeem a pair of non-slip socks with 100 MTR points. Parents/Guardians should ensure that their children avoid wearing clothing that may easily come off or become too revealing while playing on the Inflatable Paradise, as well as clothing that may pose a choking hazard.</li>
              <li>Parents/Guardians must be responsible for the safety of their children or the children they bring with them in the Inflatable Paradise and bear full responsibility for taking care of accompanying children.</li>
            ...
            <ol className="list-decimal ml-4 text-sm">
              <li>The venue must be kept clean, eating and drinking is strictly prohibited, and no food (including chewing gum) or drinks are allowed into the venue. If the Inflatable Paradise is soiled, the organizer reserves the right to charge customers a cleaning fee of HK$1,000 or above.</li>
              <li>Littering, spitting, or any other unhygienic behavior is strictly prohibited. If the Inflatable Paradise is soiled, the organizer reserves the right to charge customers a cleaning fee of HK$1,000 or above.</li>
              <li>For hygiene and safety reasons, the socks must be worn inside the Inflatable Paradise. Participants should also wear comfortable clothing. Participants can bring their non-slip socks or redeem a pair of non-slip socks with 100 MTR points. Parents/Guardians should ensure that their children avoid wearing clothing that may easily come off or become too revealing while playing on the Inflatable Paradise, as well as clothing that may pose a choking hazard.</li>
              <li>The use of obscene language or conduct deemed indecent, offensive, disturbing, or inappropriate is prohibited on the premises.</li>
            ...
            <ol className="list-decimal ml-4 text-sm">
              ...
              <li>Each Session of play for Inflatable Paradise shall be for twenty minutes. It is recommended to allow sufficient time for registration, especially if participants arrive 10 minutes before the time stated for online reservations and arrive 5 minutes before the time stated for a walk-in pass. Late arrivals will not be refunded.</li>
            ...
            <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden text-sm">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr>
                  <td className="py-3 px-4 text-left align-top">
                    <ul className="list-disc ml-4">
                      <li>Issued between 8 am and 3 pm and remained valid past 3 pm</li>
                    </ul>
                  </td>
                  <td className="py-3 px-4 text-left align-top">All activities of the day will be cancelled</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left align-top">
                    <ul className="list-disc ml-4">
                      <li>Between 8 am and 3 pm, the signal is changed to Amber or Red Rainstorm Signals, or Tropical Cyclone Warning Signal 1 or 3</li>
                    </ul>
                  </td>
                  <td className="py-3 px-4 text-left align-top">Activities will be held as scheduled after 5pm</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left italic align-top" colSpan={2}>Issued during the activities (i.e. at 1pm or after)</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left align-top">
                    <ul className="list-disc ml-4">
                      <li>Black Rainstorm Signal, or</li>
                  ...
                  <td className="py-3 px-4 text-left font-bold align-top">All activities of the day will be cancelled, as far as it is safe to do so, all participants must leave the venue before or, in the case of Black Rainstorm Signal, soon after the signal is issued</td>
                </tr>
              </tbody>
            </table>
    ...
    case 'zh-CN':
      return (
        <main role="main" className="grid justify-self-center justify-items-center w-full md:w-120 p-4">
          <section className="w-full p-8 text-center">
            <Heading level={1} content="条款及细则" className="text-4xl pt-8 pb-4" />
          </section>
          <section className="w-full p-8">
            <Heading level={2} content="入场须知" className="text-2xl pb-8" />
            <ol className="list-decimal ml-4 text-sm">
              <li>每天将会分别以网上预约及现场派筹形式参与，参与者必须通过 mtr mall 积分兑换各类入场券，每天每时段名额有限，兑完即止。</li>
              <li>出于安全考虑，参与者年龄必须介于 3 至 12 岁之间，且身高须高于 80cm。现场将提供量测工具，以现场工作人员最终决定为准。</li>
              <li>每位儿童必须由一名18岁或以上成人陪同入场，并须全程照看及照顾该名儿童。主办单位不提供任何托管服务。</li>
              <li>出于卫生与安全原因，进入充气乐园时，所有参与者必须穿着防滑袜和舒适衣物。参与者可自带或用 100 MTR 积分兑换大会提供的一双防滑袜。家长/监护人应确保儿童避免穿着可能松脱、过于暴露或有窒息风险的衣物。</li>
              <li>家长/监护人须为其子女或所带儿童在充气乐园内的安全负责，承担全部照顾责任。</li>
              <li>家长/监护人须指导及看护随行儿童，禁止在场内奔跑、推撞、打架、欺凌、乱丢物品或随地便溺，确保儿童遵循工作人员指示，否则可能被要求停止玩耍。</li>
              <li>禁止携带婴儿车、手推车、购物车，以及附有轮子的储物箱、行李或大型物品入场。</li>
              <li>进入充气乐园前，所有参与者须脱下鞋子、徽章和配饰（如大耳环、项链）及尖锐物品，以防损坏乐园设施及避免造成伤害。</li>
            </ol>
            <Heading level={2} content="卫生与安全" className="text-2xl pt-8 pb-4" />
            <ol className="list-decimal ml-4 text-sm">
              <li>须保持场地清洁，禁止饮食，不可携带食物（包括口香糖）或饮料。如弄脏场地，主办方有权收取清洁费 HK$1,000 或以上。</li>
              <li>禁止乱扔垃圾、吐痰或其他不卫生行为。如弄脏设备，主办方有权收取清洁费 HK$1,000 或以上。</li>
              <li>出于卫生与安全考虑，所有参与者必须穿袜子入场，严禁赤脚或穿鞋入内。12 岁以下儿童必须穿防滑袜。</li>
              <li>禁止使用猥亵语言或做出不雅、冒犯、攻击性、令人不安或不当行为。</li>
              <li>工作人员有权拒绝或驱逐可能传播疾病、具攻击性或暴力倾向者。</li>
              <li>不得妨碍或影响工作人员履行职责或执行场地规定。</li>
              <li>如有身体不适，请立即通知工作人员。</li>
              <li>如因不当使用设施导致受伤，运营商与主办方概不承担责任。</li>
              <li>现场设有急救箱，若有需要请联系工作人员。</li>
              <li>为保障安全，请遵循工作人员指示，场内设有全天候 CCTV 监控。</li>
              <li>为确保卫生，工作人员将定期清洁与消毒。</li>
            </ol>
            <Heading level={2} content="个人财物" className="text-2xl pt-8 pb-4" />
            <ol className="list-decimal ml-4 text-sm">
              <li>请妥善保管个人财物，避免携带贵重物品。如有遗失或损坏，主办方不承担责任。</li>
              <li>主办单位与运营商有权处理无人认领之财物，恕不另行通知。</li>
            </ol>
            <Heading level={2} content="设施" className="text-2xl pt-8 pb-4" />
            <ol className="list-decimal ml-4 text-sm">
              <li>名额适用于所有充气乐园设施，按先到先得方式兑换，每节名额有限，兑完即止。</li>
              <li>每节游玩时间为 20 分钟。建议网上预约参与者提前 10 分钟到场，现场派筹者提前 5 分钟到场登记，迟到不补时。</li>
              <li>主办方将定期检查和维修设施，如发现问题请立即通知工作人员。</li>
              <li>若参与者在乐园期间损坏设施，主办方有权要求合理赔偿，金额由主办单位决定。</li>
            </ol>
            <Heading level={2} content="恶劣天气安排" className="text-2xl pt-8 pb-4" />
            <p className="text-sm">如因台风或其他恶劣天气取消，不再另行通知，相关 MTR 积分将在 10 个工作日内退还至用户账户。详情如下表：</p>
            <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden text-sm">
              <thead className="bg-gray-100 text-gray-700">
                <tr>
                  <th className="py-3 px-4 text-left">天气情况</th>
              ...
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="py-3 px-4 text-left align-top">
                    <ul className="list-disc ml-4">
                      <li>黄色或红色暴雨警告信号</li>
                      <li>热带气旋警告信号 1 或 3</li>
                    </ul>
                  </td>
                  <td className="py-3 px-4 text-left align-top">活动照常进行</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left italic align-top" colSpan={2}>黑色暴雨或热带气旋警告信号 8 或以上</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left align-top">
                    <ul className="list-disc ml-4">
                  ...
                  <td className="py-3 px-4 text-left align-top">当天所有活动取消</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left align-top">
                    <ul className="list-disc ml-4">
                      <li>上午 8 时至下午 3 时期间发出并维持</li>
                    </ul>
                  </td>
                  <td className="py-3 px-4 text-left align-top">当天所有活动取消</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left align-top">
                    <ul className="list-disc ml-4">
                      <li>上午 8 时至下午 3 时发出，后转为黄色/红色暴雨或气旋信号 1 或 3</li>
                    </ul>
                  </td>
                  <td className="py-3 px-4 text-left align-top">下午 5 时后的活动照常举行</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left italic align-top" colSpan={2}>活动期间（即下午 12 时或之后）发出</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-left align-top">
                    <ul className="list-disc ml-4">
                      <li>黑色暴雨</li>
                      <li>气旋信号 8 或以上</li>
                      <li>宣布即将发出气旋信号 8 或以上</li>
                    </ul>
                  </td>
                  <td className="py-3 px-4 text-left font-bold align-top">当天所有活动取消，所有参与者必须尽快、安全离场。</td>
                </tr>
              </tbody>
            </table>
            <Heading level={2} content="注意事项" className="text-2xl pt-8 pb-4" />
            <ol className="list-decimal ml-4 text-sm">
              <li>幼小儿童不宜单独游玩，特别在攀爬或落地时需成人保护。</li>
              <li>家长/监护人须避免让受伤、患皮肤病、发烧、心脏病或脊椎问题的儿童参与，如不听劝告，后果自负。如有安全隐患，主办单位有权拒绝其参与。</li>
              <li>滑梯前请移除易掉物品。</li>
              <li>禁止从滑梯边缘滑下或逆行攀爬。</li>
              <li>禁止在滑梯上摇晃、跑动或跳跃等危险动作。</li>
              <li>请听从工作人员指示，多次劝导无效者将被拒绝参与活动。</li>
              <li>您接受主办单位可随时更改规则，无需事先通知。若有争议，主办单位拥有最终决定权。若中英文条款不一致，以中文为准。</li>
            </ol>
          </section>
        </main>
      );
      ...
      return (
        <main role="main" className="grid justify-self-center justify-items-center w-full md:w-120 p-4">
          <div className="m-4 bg-neutral-000 border border-neutral-000 mb-4 text-neutral-999 border-4 rounded-2xl">
            <section className="w-full p-8 text-center">
              <Heading level={1} content="條款及細則" className="text-4xl pt-8 pb-4" />
            </section>
            <section className="w-full p-8 pt-0">
              <Heading level={2} content="進場須知" className="text-2xl pb-8" />
              <ol className="list-decimal ml-4 text-sm">
                <li>每日將會分別以網上預約及現場派籌形式參加，參加者必須透過mtr mall積分換領各款入場券，每日每節時段之名額有限，換完即止。</li>
                ...
                <li>基於衛生和安全理由，在進入吹氣樂園遊玩時，所有參加者必須穿著防滑襪和舒適的衣服。參加者可現場自備或以100MTR分換領大會預備防滑襪一對。家長/監護人應確保他們的兒童避免穿著任何在吹氣樂園時，可能容易脫落或變得過於暴露或可能造成窒息危險的衣服。</li>
              ...
              <ol className="list-decimal ml-4 text-sm">
                <li>必須保持場地清潔，場内嚴禁飲食，不可攜帶食物（包括口香糖）和/或飲料進場。如弄髒吹氣樂園，主辦單位有權向參加者收取清潔費用HK$1,000元或以上。</li>
                <li>禁止亂拋垃圾、吐痰或作出任何有欠衛生的行為。如弄髒吹氣樂園及任何相關設備，主辦單位有權向參加者收取清潔費用HK$1,000或以上。</li>
                <li>基於衛生和安全考量，所有參加者必須穿著襪子進入場內，嚴禁赤腳或穿鞋入內。所有未滿12歲小童必須穿著防滑襪參加者可自備或以100 MTR 分換領大會預備防滑襪一對。 防滑襪子是不否合格以在場工作人員之最終決定為準。</li>
                ...
                <li>為保障參加者之安全，請遵循現場工作人員之指示，場内亦設有閉路電視監察系統進行 24小時監察。</li>
                <li>為確保場内清潔，工作人員在場内會定時清潔及消毒。</li>
              </ol>
              <Heading level={2} content="個人財物" className="text-2xl pt-8 pb-4" />
              <ol className="list-decimal ml-4 text-sm">
                <li>進場遊玩時，參加者應小心看管個人財物，避免攜帶任何貴重物品進場。如有遺失或損毁，主辦單位概不負責。</li>
              ...
              <ol className="list-decimal ml-4 text-sm">
                ...
                <li>每節吹氣樂園的遊戲時間為二十分鐘。建議對於網上預約所列的時間提早10分鐘前到達﹔現場派籌之參加者請於門票所例的時間提早5分鐘前到達，以便預留足夠時間登記，遲到將不獲補時。</li>
                <li>主辦單位將定期安排人員檢查及維修各項設施，若參加者發現場內任何設施損壞，請即通知場內工作人員。</li>
              ...
              <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden text-sm">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-4 text-left font-bold align-top">當天所有活動取消，在安全情況下，所有參加者必須在信號發出前或在黑色暴雨警告信號的情況下儘快離開場地。</td>
                  </tr>
                </tbody>
              </table>
